...
public class SinelithLPF50A {
    ...
    public SinelithLPF50A(RegionsDao regionsDao, DevicesDao devicesDao, DeviceNodesDao deviceNodesDao, TrimVarBindMessage trimVarBindMessage,
